...
/*
index is randomized so is the number
maintain a hashtable to store the number-index relationship
update both the data vector and the lookup table during addition/removal
*/
class RandomizedSet {
public:
